...
def objective(hyperopt_params):
    ...
    write_results_dict = {
        ...
        'taxes_total': scenario.resultat_net.charges_sociales_sur_salaire_president + scenario.resultat_net.impots_sur_les_societes + scenario.resultat_dividendes.charges_sur_dividendes + scenario.resultat_IR.impot_sur_le_revenu,
    ...
    return {'loss': -scenario.president_net_apres_IR, 'status': STATUS_OK, 'dividendes_recus': scenario.resultat_dividendes.dividendes_recus_par_president_annuellement, 'reste_tresorerie': scenario.resultat_dividendes.reste_tresorerie, 'write_results_dict': write_results_dict}
